...
class Toontown(commands.Cog):
    ...
    async def invasions(self, ctx):
        ...
        for invasion in cog_invasions:
            ...
            cog_img_url = "https://toonhq.org/static/assets/cogs/{}.png".format(('_'.join(cog_name.split())).lower())

            if cog_name == "Back Stabber":
                cog_img_url = "https://toonhq.org/static/assets/cogs/backstabber.png"
            elif cog_name == "Yesman":
                cog_img_url = "https://toonhq.org/static/assets/cogs/yes_man.png"
            elif cog_name == "Two-Face":
                cog_img_url = "https://toonhq.org/static/assets/cogs/two_face.png"
            elif cog_name == "Mover & Shaker":
                cog_img_url = "https://toonhq.org/static/assets/cogs/mover_and_shaker.png"
            elif cog_name == "Mr. Hollywood":
                cog_img_url = "https://toonhq.org/static/assets/cogs/mr_hollywood.png"
            elif "(Skelecog)" in cog_name:
                cog_img_url = "https://toonhq.org/static/assets/cogs/skelecog.png"
